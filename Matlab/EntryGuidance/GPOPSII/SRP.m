...
else  % No final position requirement, even altitude 
    bounds.phase(iphase).finalstate.lower          = [-1e4 -1e4 -1e4 uf vf wfmin mmin];
bounds.phase(iphase).finalstate.upper          = [1e4 1e4 1e4 uf vf wfmax mmax];
end
